...
class PosteriorSampling_meng(ConditioningMethod):
    ...
    def conditioning(self, x_prev, x_t, x_0_hat, measurement, H_funcs, noise_std, alpha_t, alpha_bar, gamma, pseudonoise_scale,  **kwargs):
        ...
        grad_value = grad_value/(1+gamma*torch.norm(grad_value))
